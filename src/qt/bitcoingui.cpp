 ...
 * The Erupees developers 2011-2017
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Erupees") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/erupees"));
    setWindowIcon(QIcon(":icons/erupees"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Erupees address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/erupees"), tr("&About Erupees"), this);
    aboutAction->setStatusTip(tr("Show information about Erupees"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Erupees"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/erupees"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Erupees addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Erupees addresses"));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/erupees_testnet"));
            setWindowIcon(QIcon(":icons/erupees_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/erupees_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Erupees client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Erupees network", "", count));
}
...
{
    QString strTitle = tr("Erupees"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Erupees address or malformed URI parameters."),
