...
// erpcoin: sync-checkpoint master key
...
// erpcoin: synchronized checkpoint (centrally broadcasted)
...
// erpcoin: get last synchronized checkpoint
...
// erpcoin: only descendant of current sync-checkpoint is allowed
...
// erpcoin: reset synchronized checkpoint to last hardened checkpoint
...
// erpcoin: find block wanted by given orphan block
...
// erpcoin: verify signature of sync-checkpoint message
...
// erpcoin: process synchronized checkpoint
...
// get information of sync-checkpoint (first introduced in erpcoin)
