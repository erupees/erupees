...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Erupees " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seederupees", "seed.erupees.net"},
    {"seed", "seed.erpcoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tseederupees", "tseed.erupees.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Erupees is probably already running."), addrBind.ToString().c_str());
        else
